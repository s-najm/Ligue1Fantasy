...
# Ligue 1 URL (competition ID 13)
html = requests.get('https://fbref.com/en/comps/13/Ligue-1-Stats').text ##getting the html from the website
...
stat_df.to_csv("ligue1_stats.csv") ## importing to csv
